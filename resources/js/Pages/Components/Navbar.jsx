        ...
        <nav className="fixed navbar z-50 backdrop-filter backdrop-blur-3xl">
            ...
            {/* <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1 font-bold text-white">
                    ...
                    <li className="text-base"><Link href="/shop">Shop</Link></li>
                    <li className="text-base"><Link href="">About</Link></li>
                </ul>
            </div> */}
            <div className="navbar-end">
                ...
                <div className="mr-3 dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                        <div className="text-white text-[] indicator">
                    ...
                    <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                        <div className="card-body">
                            ...
                            <span className="text-info">Subtotal: Rp. 0,00</span>
